...
//
//public class StealShip implements BaseCommand {
//    public static void stealShip(ShipAPI target, boolean creditKillToPlayer) {
//        if (target == null) {
//            return;
//        }
//
...
//        }
//
//        stealShip(target, true);
//        Console.showMessage("Stole " + target.getVariant().getFullDesignationWithHullName() + ".");
